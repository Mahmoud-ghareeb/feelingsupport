    ...
    <div class="row justify-content-center">
        <div class="col-md-8" style="margin-top: 30px;">
            <div class="card" style="border-radius: 39px;">
                <!-- <div class="card-header login-card-header text-center">{{ __('Register') }}</div> -->
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('messages.User Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="first_name" class="col-md-4 col-form-label text-md-end">{{ __('messages.first_name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="last_name" class="col-md-4 col-form-label text-md-end">{{ __('messages.last_name') }}</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-2">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms" style="margin: 0px 25px;">
                                        {{ __('messages.i agree on the') }} <a style="text-decoration: underline;" href="{{route('terms')}}">{{__('messages.terms and condition')}}</a>
                                    </label>
                                </div>
                                @error('terms')
                                    <span class="invalid-feedback" role="alert">
