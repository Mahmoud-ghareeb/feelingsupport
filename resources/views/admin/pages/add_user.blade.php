...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> Add user
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3">Add user form</h4>

                <form class="required-form" action="{{route('admin.create.users')}}" enctype="multipart/form-data" method="post">
                    @csrf
